...
const RefundModal = ({
  ...
  const eventDate = new Date(bookingDate.split("-").reverse().join("-")); // Convert DD-MM-YYYY to YYYY-MM-DD
  ...
  else if (daysDifference >= 1) refundPercentage = 0; // Still show modal but no refund
      ...
      <div className="bg-white p-6 rounded-lg max-w-md w-full">
        ...
        <div className="mb-4 text-sm text-gray-600">
          ...
          <ul className="list-disc pl-4">
            <li>
              75% refund within 5-7 working days, if notified 8+ days prior
            </li>
            <li>
              50% refund within 5-7 working days, if notified 4-7 days prior
            </li>
...
const Booked = () => {
  ...
  const handleRefundConfirm = (refundPercentage: number) => {
    console.log(
      `Processing ${refundPercentage}% refund for booking ${selectedBooking}`
    );
    setSelectedBooking(null);
    // Update booking status to 'refund' in your state or refetch data
  };
