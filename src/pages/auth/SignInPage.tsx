...
const SignInPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (resp.success) {
        ...
        setTimeout(() => navigate(from || "/", { replace: true }), 1000); // Show loader before navigation
      }
    } catch (error) {
  ...
  return (
    ...
    >
      <AuthCard title="Welcome Back" subtitle="Sign in to your account to continue booking">
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <PasswordInput id="password" label="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} error={errors.password} />
          </div>
